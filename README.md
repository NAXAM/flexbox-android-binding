...
![FlexboxLayoutManager in action](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/flexbox-layoutmanager.gif)
...
| ------- |:-----------:|:----------------------------------:|
|flexDirection|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|flexWrap|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png) (except `wrap_reverse`)|
|justifyContent|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|alignItems|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|alignContent|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)| - |
|layout_order|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)| - |
|layout_flexGrow|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|layout_flexShrink|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|layout_alignSelf|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|layout_flexBasisPercent|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|layout_(min/max)Width|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|layout_(min/max)Height|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|layout_wrapBefore|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|Divider|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|View recycling| - |![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
|Scrolling| *1 |![Check](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/pngs/check_green_small.png)|
  ...
  * This attribute determines the direction of the main axis (and the cross axis, perpendicular to the main axis). The direction children items are placed inside the Flexbox layout.
  Possible values are:
    ...
    * column_reverse
    ...
    ![Flex Direction explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/flex-direction.gif)
  ...
  * This attribute controls whether the flex container is single-line or multi-line, and the
  direction of the cross axis. Possible values are:
    ...
    * wrap_reverse
    ...
    ![Flex Wrap explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/flex-wrap.gif)
...
* __justifyContent__
  * This attribute controls the alignment along the main axis. Possible values are:
    ...
    * space_around
    ...
    ![Justify Content explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/justify-content.gif)
...
* __alignItems__
  * This attribute controls the alignment along the cross axis. Possible values are:
    ...
    * baseline
    ...
    ![Align Items explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/align-items.gif)
  ...
  * This attribute controls the alignment of the flex lines in the flex container. Possible values
  are:
    ...
    * space_around
    ...
    ![Align Content explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/align-content.gif)
...
* __dividerDrawable__ (reference to a drawable)
  * Shorthand for setting both horizontal and vertical dividers. Note that if used with other attributes
  ...
  ![Dividers beginning and middle](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/divider-beginning-middle.png)
...
* __layout_order__ (integer)
  * This attribute can change how the ordering of the children views are laid out.
  ...
  layout XML. If not specified, `1` is set as a default value.
    ...
    ![Order explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/layout_order.gif)
...
* __layout_flexGrow__ (float)
  * This attribute determines how much this child will grow if positive free space is
  ...
  If not specified, `0` is set as a default value.
    ...
    ![Flex Grow explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/layout_flexGrow.gif)
...
* __layout_flexShrink__ (float)
  * This attribute determines how much this child will shrink if negative free space is
  ...
  If not specified, `1` is set as a default value.
    ...
    ![Flex Shrink explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/layout_flexShrink.gif)
  ...
  * This attribute determines the alignment along the cross axis (perpendicular to the
  ...
  `auto`, the cross axis alignment is overridden for this child. Possible values are:
    ...
    * stretch
    ...
    ![Align Self explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/layout_alignSelf.gif)
...
* __layout_flexBasisPercent__ (fraction)
  * The initial flex item length in a fraction format relative to its parent.
  ...
  `MeasureSpec.EXACTLY`). The default value is `-1`, which means not set.
    ...
    ![Flex basis percent explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/layout_flexBasisPercent.gif)
...
* __layout_minWidth__ / __layout_minHeight__ (dimension)
  * These attributes impose minimum size constraints for the children of FlexboxLayout.
  ...
  main axis) regardless of the `layout_flexShrink` attribute.
    ...
    ![Min width explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/layout_minWidth.gif)
...
* __layout_maxWidth__ / __layout_maxHeight__ (dimension)
  * These attributes impose maximum size constraints for the children of FlexboxLayout.
  ...
  main axis) regardless of the `layout_flexGrow` attribute.
    ...
    ![Max width explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/layout_maxWidth.gif)
...
* __layout_wrapBefore__ (boolean)
  * This attribute forces a flex line wrapping, the default value is `false`.
  ...
  to put a new flex line to make a semantic difference from the previous one, etc.
    ...
    ![Wrap before explanation](https://raw.githubusercontent.com/google/flexbox-layout/master/assets/layout_wrapBefore.gif)
